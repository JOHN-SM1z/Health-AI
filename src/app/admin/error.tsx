...
/**
 * Catches uncaught errors anywhere under /admin — including a thrown
 * getStaffContext() (e.g. Supabase unreachable) in admin/layout.tsx itself,
    ...
    <div className="flex min-h-dvh flex-col items-center justify-center px-4 py-10">
      <div className="w-full max-w-sm">
        ...
        <Card className="flex flex-col gap-3 p-6">
          ...
          <a href="/admin" className="text-center text-sm text-pine-deep hover:underline">
